...
namespace engine
{
    class fetchfromengine
    {
        ...
        public async Task<string> start(int pagenum, string query, string sort,int start=0)
        {
            ...
            string uri =api_key+ "&cx=" + cx_id+ "&num=" + pagenum.ToString() +"&q=" + query.Replace(" ", "%20") + "&sort=" + sort + "&hl=en" + "&start=" + start ;
